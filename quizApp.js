...
//Let's say three people signed up for our service, create 3 instances of User and add each to the users Array
  ...
  quizUsers.push(new QuizUser('hunter', 'hunter@gmail.com', 'blue', '10'));
  quizUsers.push(new QuizUser('brett', 'brett@gmail.com', 'brown', '8'));
  quizUsers.push(new QuizUser('forrest', 'forrest@gmail.com', 'green', '2'));
...
questions.push(new Question('T/F: Inheritance is achieved in JavaScript through Prototypes?', ['T','F'], 'T', 'Medium'));
